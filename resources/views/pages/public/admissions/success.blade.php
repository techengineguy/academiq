...
<div class="mx-auto grid w-full max-w-5xl px-4 py-8 lg:px-6">
    <section class="bg-linear-to-br from-emerald-950 via-emerald-900 to-emerald-800 p-8 text-white shadow-2xl ring-1 ring-white/10">
        <div class="space-y-6">
            ...
            <div>
                <div class="flex items-center gap-3">
                    ...
                    <h1 class="text-2xl font-bold tracking-tight">{{ __('Application Submitted') }}</h1>
                </div>
            ...
            <div class="grid gap-4 sm:grid-cols-3">
                ...
                <div class="rounded-2xl bg-white/5 p-4 ring-1 ring-white/10">
                    ...
                    <p class="mt-1 text-lg font-semibold capitalize">{{  $application->status }}</p>
                </div>
                <div class="rounded-2xl bg-white/5 p-4 ring-1 ring-white/10">
