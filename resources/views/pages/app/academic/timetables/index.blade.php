...
<div>
    <div class="space-y-6">
        <div class="flex items-center justify-between">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Timetables</h1>
            <flux:button href="{{ route('timetables.create') }}" wire:navigate icon="plus">
                {{ __('New Timetable') }}
            </flux:button>
        </div>
