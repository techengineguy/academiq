...
<div class="py-4 space-y-6">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">{{ __('Manage your time slots.') }}</p>
        </div>
        <flux:button class="button w-fit" x-on:click="$tsui.open.slide('create-time-slot')" icon="plus">
            {{ __('New Time Slot') }}
        </flux:button>
    </div>
