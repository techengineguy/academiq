...
new #[Title('Listings Lesson Plans')] 
...
<div>
    <div class="space-y-6">
        <div class="flex items-center justify-between">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Lesson Plans</h1>
            <flux:button href="{{ route('lesson-plans.create') }}" wire:navigate icon="plus">
                {{ __('New Lesson Plan') }}
            </flux:button>
        </div>
