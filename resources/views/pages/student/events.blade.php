...
<div class="space-y-6 py-4">
    <div>
        ...
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">{{ __('Upcoming school events and activities.') }}</p>
    </div>
                    ...
                    <div class="rounded-lg border border-gray-200 dark:border-zinc-700 p-4">
                        <div class="flex items-start justify-between mb-2">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <flux:badge :color="$event->status === 'upcoming' ? 'blue' : 'yellow'" size="sm">{{ ucfirst($event->status) }}</flux:badge>
                            </div>
                        </div>
