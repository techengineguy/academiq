...
class extends Component {
    ...
    public function save(): void
    {
        ...
        $this->redirect(route('accountant.payroll'), navigate: true);
    }
...
<div>
    ...
    <form wire:submit="save" class="space-y-6">
        ...
        <div class="flex gap-3 pt-2">
            ...
            <flux:button type="button" x-on:click="$tsui.close.slide('create-payroll')" variant="subtle">{{ __('Cancel') }}</flux:button>
        </div>
    </form>
</div>
