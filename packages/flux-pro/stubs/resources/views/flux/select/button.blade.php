...
$classes = Flux::classes()
    ...
    ->add($floating
        ? 'pt-4 pb-2.5 bg-transparent shadow-none border border-zinc-500/50 dark:border-zinc-500/50 focus:outline-none focus:ring-0 focus:ring-offset-0 focus:border-zinc-500/50 dark:focus:border-zinc-500/50'
        : 'py-2 shadow-xs bg-white dark:bg-white/10 dark:disabled:bg-white/[7%] disabled:shadow-none'
    )
    ->add($floating
        ? ($invalid ? 'border-red-500' : '')
        : ($invalid ? 'border border-red-500' : 'border border-zinc-200 border-b-zinc-300/80 dark:border-white/10')
    )
    ;
@endphp
